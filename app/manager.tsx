...
const s = StyleSheet.create({
  ...
  kpiCard: { flex: 1, backgroundColor: colors.white, padding: 12, borderRadius: 14 },
  kpiLabel: { fontSize: 11, fontWeight: '800', color: colors.muted },
  kpiValue: { fontSize: 18, fontWeight: '900', color: colors.espresso, marginVertical: 2 },
  kpiSub: { fontSize: 10, color: colors.muted },
  sectionCard: { backgroundColor: colors.white, borderRadius: 16, padding: 14, marginBottom: 14 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  sectionTitle: { fontSize: 12, fontWeight: '800', color: colors.espresso, letterSpacing: 0.6 },
  emptyStaffText: { fontSize: 12, color: colors.muted },
  staffList: { gap: 8 },
  staffRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 4 },
  statusDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#2D7D46' },
  staffItemName: { fontSize: 13, fontWeight: '800', color: colors.espresso },
  staffItemTime: { fontSize: 11, color: colors.muted },
  knobLabel: { fontSize: 11, fontWeight: '800', color: colors.muted, marginBottom: 6 },
  rushButtonsRow: { flexDirection: 'row', gap: 6, marginBottom: 12 },
  rushBtn: { flex: 1, paddingVertical: 8, alignItems: 'center', backgroundColor: colors.cream, borderRadius: 8 },
  rushBtnActive: { backgroundColor: colors.espresso },
  rushBtnText: { fontSize: 11, fontWeight: '800', color: colors.espresso },
  rushBtnTextActive: { color: colors.white },
  pauseRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 10, borderTopWidth: 1, borderTopColor: colors.line },
  pauseTitle: { fontSize: 13, fontWeight: '800', color: colors.danger },
  pauseDesc: { fontSize: 11, color: colors.muted },
  gridTitle: { fontSize: 12, fontWeight: '800', color: colors.caramel, letterSpacing: 1, marginTop: 6, marginBottom: 10 },
  linkGrid: { gap: 10 },
  actionCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.white, padding: 14, borderRadius: 14, borderWidth: 1, borderColor: colors.line },
  actionIconWrap: { width: 38, height: 38, borderRadius: 10, backgroundColor: colors.cream, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  actionTitle: { fontSize: 14, fontWeight: '800', color: colors.espresso },
