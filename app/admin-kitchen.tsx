...
const s = StyleSheet.create({
  ...
  orderCard: { padding: 16, marginBottom: 12, borderRadius: 18, borderWidth: 1.5, borderColor: colors.line, ...shadows.sm },
  ...
  statusBadgeText: { fontSize: 9, fontWeight: '900', color: colors.ink },
  orderId: { fontSize: 16, fontWeight: '900', color: colors.espresso },
  pickupCode: { color: colors.caramel },
  timerBox: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#E6F4EA', paddingHorizontal: 10, paddingVertical: 5, borderRadius: radii.full },
  timerBoxWarning: { backgroundColor: '#FFF3CD' },
  timerBoxLate: { backgroundColor: colors.danger },
  timerText: { fontSize: 11, fontWeight: '900', color: colors.ink },
  itemsBox: { borderTopWidth: 1, borderTopColor: colors.line, paddingTop: 10, marginBottom: 12, gap: 8 },
  itemRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 },
  qtyPill: { backgroundColor: colors.cream, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  qtyPillText: { fontSize: 12, fontWeight: '900', color: colors.espresso },
  productName: { fontSize: 14, fontWeight: '800', color: colors.espresso },
  modifierText: { fontSize: 11, color: colors.muted },
  itemNotes: { fontSize: 11, color: colors.caramel, fontStyle: 'italic' },
  bumpButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.espresso, paddingVertical: 13, borderRadius: 14, ...shadows.sm },
  bumpButtonComplete: { backgroundColor: colors.green },
  bumpButtonText: { color: colors.white, fontSize: 14, fontWeight: '900' },
  reopenBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, marginTop: 10 },
  reopenBtnText: { color: colors.caramel, fontSize: 12, fontWeight: '800' },
});
